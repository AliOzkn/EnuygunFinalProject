...
*/
public class SwaggerPetTestWithSoldParameter {
    Response response;
    String firstId;

    public SwaggerPetTestWithSoldParameter() {
    ...
    @Test(priority = 1)
    @Story("This method finds pets by status as 'sold'. And puts them on a list.")
    @Feature("Find pets by status as 'sold'")
    public void findsPetsByStatus() {
        ...
        assertTrue(status.contains("sold"));
